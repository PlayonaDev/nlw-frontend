...
export default function InvitePage() {
    const inviteLink = "https://localhost:3000/invite/67bb50e7-e035-4399-9ce6-cfb6fe0a2f55";
    return (
        <div className='min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row'>
            <div className='flex flex-col gap-10 w-ful max-w-[550px]'>
                <Image src={logo} alt="devstage" width={108.5} height={30} />
                <div className='space-y-2'>
                    <h1 className='text-4xl font-semibold font-heading text-gray-100 leading-none'>Incrição confirmada</h1>
